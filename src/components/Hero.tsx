...
export default function Hero() {
  ...
  return (
    <div className={`relative overflow-hidden ${isDark ? 'bg-gray-900' : 'bg-white'} pt-16`}>
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8 min-h-[70vh] flex items-center">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-4 mt-4 justify-center">
            <div className={`w-1 h-8 ${isDark ? 'bg-white' : 'bg-black'} rounded-full`}></div>
          ...
          <div className="mt-6">
            <button className={`rounded-lg ${isDark ? 'bg-white text-gray-900 hover:bg-gray-100' : 'bg-black text-white hover:bg-gray-900'} px-6 py-3 text-base font-semibold shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all`}>
